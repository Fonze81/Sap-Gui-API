...
class GuiComponent():
    ...
    The difference is that the reference is made by the element attribute and
    not directly to the object.
    The reference can be made on initialization or by setting the element
    attribute.

    Note:
        For more information, see the developer guide for SAP GUI Scripting
        API, version 7.60 PL1 – 2019-03-28, item 1.2.15, page 78.
    ...
    def element(self) -> object:
        ...
        The link between the SAP element and this object is made by the
        'element' attribute.
        Is defined at initialization or by setting this attribute.
        Checks if the SAP element is compatible with the expected types for
        this class defined in the 'VALID_TYPES' constant.
        If the '____validate_type' attribute is 'false', validation is disabled.
        This is not recommended, except for collections.
    ...
    def container_type(self) -> bool:
        ...
        This property is TRUE, if the object is a container and therefore has
    ...
    def id(self) -> str:
        ...
        It is built in a URLlike formatting, starting at the GuiApplication
    ...
    def name(self) -> str:
        ...
        The name property is especially useful when working with simple scripts
        that only access dynpro fields.
    ...
    def type(self) -> str:
        ...
        The type information of GuiComponent can be used to determine which
        properties and methods an object supports.
    ...
    def type_as_number(self) -> int:
        ...
        Returns:
            int: Possible values for this property are taken from the
    ...
    def __has_valid(self, value: str) -> bool:
        ...
        Hint!!! It's possible that the SAP interface has been updated and the
            object has lost the reference.
        Hint!!! It's possible that the connection to SAP was dropped.
        Hint!!! It's possible that has occurred an access violation to the
            protected attribute '_element'.

        Args:
            value (str): Name of the SAP property.

        Raises:
            TypeError: None Type. The object was not referenced to a SAP
                element.
            TypeError: This object does not have the property.
        ...
        if self._element is None:
            ...
            message: str = f"""The '{self}' object does not have the '{value}' property.
                Validation is performed at object initialization or setting
                    the 'element' attribute.
                Hint!!! It's possible that the SAP interface has been updated
                    and the object has lost the reference.
                Hint!!! It's possible that the connection to SAP was terminated
                    or dropped.
                Hint!!! It's possible that has occurred an access violation to
                    the protected attribute '_element'."""
            logger.error(message)
            raise TypeError(message)
        else:
            result: Literal[True] = True
    ...
    def text(self) -> str:
        ...
        Returns:
            str: The value of this property very much depends on the type of
                the object on which it is called. This is obvious for text
                fields or menu items. On the other hand this property is empty
                for toolbar buttons and is the class id for shells.
                You can read the text property of a label, but you can’t
                change it, whereas you can only set the text property of a
